...
public class CustomEreportSpinnerAdapter extends BaseAdapter {

    private final List<String> list;
    private final LayoutInflater inflater;
    private String text;

    public CustomEreportSpinnerAdapter(Context context, List<String> list) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null)
            convertView = inflater.inflate(R.layout.spinner_ereport_outer_view, parent, false);
        if (list != null) {
